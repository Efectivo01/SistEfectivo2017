...
Public Class ReporteEstCuen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.ReporteEstCuen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteEstCuen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteEstCuen = New ReporteEstCuen()
        rpt.Site = Me.Site
        Return rpt
    End Function
