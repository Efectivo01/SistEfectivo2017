...
Public Class NotaCreditoV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.NotaCreditoV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaCreditoV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaCreditoV = New NotaCreditoV()
        rpt.Site = Me.Site
        Return rpt
    End Function
