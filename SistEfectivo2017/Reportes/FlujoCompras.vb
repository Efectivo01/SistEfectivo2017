...
Public Class FlujoCompras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.FlujoCompras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFlujoCompras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FlujoCompras = New FlujoCompras()
        rpt.Site = Me.Site
        Return rpt
    End Function
