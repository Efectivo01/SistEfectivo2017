...
Public Class ExistenciaDiv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.ExistenciaDiv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExistenciaDiv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExistenciaDiv = New ExistenciaDiv()
        rpt.Site = Me.Site
        Return rpt
    End Function
