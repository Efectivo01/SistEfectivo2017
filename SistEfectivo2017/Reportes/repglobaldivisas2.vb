...
Public Class repglobaldivisas2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.repglobaldivisas2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrepglobaldivisas2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repglobaldivisas2 = New repglobaldivisas2()
        rpt.Site = Me.Site
        Return rpt
    End Function
