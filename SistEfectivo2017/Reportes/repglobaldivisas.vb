...
Public Class repglobaldivisas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.repglobaldivisas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrepglobaldivisas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repglobaldivisas = New repglobaldivisas()
        rpt.Site = Me.Site
        Return rpt
    End Function
