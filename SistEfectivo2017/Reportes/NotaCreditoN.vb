...
Public Class NotaCreditoN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.NotaCreditoN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNotaCreditoN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NotaCreditoN = New NotaCreditoN()
        rpt.Site = Me.Site
        Return rpt
    End Function
