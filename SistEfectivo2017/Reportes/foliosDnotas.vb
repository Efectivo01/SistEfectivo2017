...
Public Class foliosDnotas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.foliosDnotas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedfoliosDnotas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As foliosDnotas = New foliosDnotas()
        rpt.Site = Me.Site
        Return rpt
    End Function
