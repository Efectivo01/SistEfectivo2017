...
Public Class invedetallediv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.invedetallediv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedinvedetallediv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As invedetallediv = New invedetallediv()
        rpt.Site = Me.Site
        Return rpt
    End Function
