...
Public Class ReporteEstCuenTick
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.ReporteEstCuenTick.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteEstCuenTick
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteEstCuenTick = New ReporteEstCuenTick()
        rpt.Site = Me.Site
        Return rpt
    End Function
