...
Public Class ReportePuntosMov
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.ReportePuntosMov.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportePuntosMov
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportePuntosMov = New ReportePuntosMov()
        rpt.Site = Me.Site
        Return rpt
    End Function
