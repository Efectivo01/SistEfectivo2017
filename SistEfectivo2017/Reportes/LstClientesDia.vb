...
Public Class LstClientesDia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.LstClientesDia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLstClientesDia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LstClientesDia = New LstClientesDia()
        rpt.Site = Me.Site
        Return rpt
    End Function
