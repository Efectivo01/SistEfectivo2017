...
Public Class RepMontoIncentivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistEfectivo2017.RepMontoIncentivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepMontoIncentivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepMontoIncentivo = New RepMontoIncentivo()
        rpt.Site = Me.Site
        Return rpt
    End Function
