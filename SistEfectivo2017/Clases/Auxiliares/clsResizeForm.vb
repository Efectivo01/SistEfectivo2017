...
Public Class clsResizeForm
    ...
    Public Sub ResizeForm(ObjForm As Form, DesignerWidth As Integer, DesignerHeight As Integer)
        ...
        For Each c As Control In ObjForm.Controls
            ...
            Else
                c.Font = New Font(c.Font.FontFamily, (c.Font.Size / f_HeightRatio) + 2, c.Font.Style, c.Font.Unit, (CByte(0)))
            End If
        Next
        ObjForm.Font = New Font(ObjForm.Font.FontFamily, (ObjForm.Font.Size / f_HeightRatio) + 2, ObjForm.Font.Style, ObjForm.Font.Unit, (CByte(0)))
    End Sub
    Private Sub ResizeControlStore(objCtl As Control)
        If objCtl.HasChildren Then
            For Each cChildren As Control In objCtl.Controls
                ...
                Else
                    cChildren.Font = New Font(cChildren.Font.FontFamily, (cChildren.Font.Size / f_HeightRatio) + 1, cChildren.Font.Style, cChildren.Font.Unit, (CByte(0)))
                End If
            Next
            objCtl.Font = New Font(objCtl.Font.FontFamily, (objCtl.Font.Size / f_HeightRatio) + 1, objCtl.Font.Style, objCtl.Font.Unit, (CByte(0)))
        Else
            objCtl.Font = New Font(objCtl.Font.FontFamily, (objCtl.Font.Size / f_HeightRatio) + 1, objCtl.Font.Style, objCtl.Font.Unit, (CByte(0)))
        End If
    End Sub
