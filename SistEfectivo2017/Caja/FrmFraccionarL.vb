...
Public Class FrmFraccionarL
    ...
    Private Sub CargarExistencia()
        ...
        tConection.Open()
        Dim consulta As String = "SELECT * FROM Existencia where fecha='" & FechaAct.ToString("dd/MM/yyyy") & "' and nosucursal='" & No_Sucursal & "' and tipo = 4"
