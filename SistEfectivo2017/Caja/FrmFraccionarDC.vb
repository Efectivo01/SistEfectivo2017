...
Public Class FrmFraccionarDC
    ...
    Private Sub CargarExistencia()
        ...
        tConection.Open()
        Dim consulta As String = "SELECT * FROM Existencia where fecha='" & FechaAct.ToString("dd/MM/yyyy") & "' and nosucursal='" & No_Sucursal & "' and tipo = 3"
    ...
    Private Sub btnb1_Click(sender As Object, e As EventArgs) Handles btnb1.Click
        If btnb1.Text <> "" Then
            btn12.Text = "$0"
            codigoD = "DC2"
            descripcionD = "DOLAR CANADIENSE 002"
            If DolarEntregado Then
                ValidarRepetido()
            Else
                ValidarRepetido2()
    ...
    Private Sub btnb2_Click(sender As Object, e As EventArgs) Handles btnb2.Click
        If btnb1.Text <> "" Then
            btn12.Text = "$0"
            codigoD = "DC5"
            descripcionD = "DOLAR CANADIENSE 005"
            If DolarEntregado Then
                ValidarRepetido()
            Else
                ValidarRepetido2()
    ...
    Private Sub btnb3_Click(sender As Object, e As EventArgs) Handles btnb3.Click
        If btnb1.Text <> "" Then
            btn12.Text = "$0"
            codigoD = "DC10"
            descripcionD = "DOLAR CANADIENSE 010"
            If DolarEntregado Then
                ValidarRepetido()
            Else
                ValidarRepetido2()
    ...
    Private Sub btnb4_Click(sender As Object, e As EventArgs) Handles btnb4.Click
        If btnb1.Text <> "" Then
            btn12.Text = "$0"
            codigoD = "DC20"
            descripcionD = "DOLAR CANADIENSE 020"
            If DolarEntregado Then
                ValidarRepetido()
            Else
                ValidarRepetido2()
    ...
    Private Sub btnb5_Click(sender As Object, e As EventArgs) Handles btnb5.Click
        If btnb1.Text <> "" Then
            btn12.Text = "$0"
            codigoD = "DC50"
            descripcionD = "DOLAR CANADIENSE 050"
            If DolarEntregado Then
                ValidarRepetido()
            Else
                ValidarRepetido2()
    ...
    Private Sub btnb6_Click(sender As Object, e As EventArgs) Handles btnb6.Click
        If btnb1.Text <> "" Then
            btn12.Text = "$0"
            codigoD = "DC100"
            descripcionD = "DOLAR CANADIENSE 100"
            If DolarEntregado Then
                ValidarRepetido()
            Else
                ValidarRepetido2()
    ...
    Private Sub btnb7_Click(sender As Object, e As EventArgs) Handles btnb7.Click
        If btnb7.Text <> "" Then
            btn12.Text = "$0"
            codigoD = "DC1000"
            descripcionD = "DOLAR CANADIENSE 1000"
            If DolarEntregado Then
                ValidarRepetido()
            Else
                ValidarRepetido2()
